...
CREATE TABLE `community_images` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `community_images_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `community_posts` (`id`),
  CONSTRAINT `community_images_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `promenade_images`
--
...
CREATE TABLE `promenade_images` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `promenade_id` (`promenade_id`),
  CONSTRAINT `promenade_images_ibfk_1` FOREIGN KEY (`promenade_id`) REFERENCES `promenade_posts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
